...
/**
 * Created by Nizar Assegaf on 25,October,2019
 */
    ...
    suspendCoroutine<ViewAnimation> { continuation ->
        view.post {
            ...
            viewAnimation.left?.let {
                animations.add(
                    ObjectAnimator.ofFloat(view, View.X, 1f * view.x, 1f * it)
                )
            }
